...
trainerdata 4, "Wade"
    ...
    party 4
        ...
        ball ITEM_NET_BALL
        setivs 20, 20, 20, 31, 20, 20 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_TIMID
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 6, "Keith"
    ...
    party 6
        ...
        abilityslot 0
        level 27
        monwithform SPECIES_GROWLITHE, 1 //-Hisui
        ...
        setivs 22, 22, 22, 22, 22, 22 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_BOLD
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 8, "Joey"
    ...
    party 8
        ...
        abilityslot 32
        level 7
        monwithform SPECIES_RATTATA, 1 //-Alola
        item ITEM_NONE
...
trainerdata 12, "Grunt"
    ...
    party 12
        ...
        ball ITEM_POKE_BALL
        setivs 15, 15, 15, 14, 14, 15 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_HASTY
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 18, "Justin & Emma"
    ...
    party 18
        ...
        ball ITEM_POKE_BALL
        setivs 15, 15, 15, 15, 14, 14 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_RELAXED
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 25, "Russel"
    ...
    party 25
        ...
        abilityslot 0
        level 18
        monwithform SPECIES_FARFETCHD, 1 //-Galar
        item ITEM_LEEK
...
trainerdata 26, "Roland & Mika"
    ...
    party 26
        ...
        ball ITEM_POKE_BALL
        setivs 15, 14, 15, 14, 14, 15 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
...
trainerdata 27, "Liz"
    ...
    party 27
        ...
        ability ABILITY_INTIMIDATE
        ball ITEM_POKE_BALL
        setivs 14, 15, 15, 15, 16, 15 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_NAIVE
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
        ...
        abilityslot 0
        level 17
        monwithform SPECIES_GEODUDE, 1 //-Alola
        item ITEM_MUSCLE_BAND
...
trainerdata 30, "Whitney"
    ...
    party 30
        ...
        setivs 24, 24, 24, 24, 24, 24 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_ADAMANT
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 34, "Chuck"
    ...
    party 34
        ...
        setivs 25, 31, 25, 25, 25, 25 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_JOLLY
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
        ...
        nature NATURE_CAREFUL
        shinylock 0
        additionalflags TRAINER_DATA_EXTRA_TYPE_STATUS // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
        status 8 // prepoison
        ballseal 0
        ...
        abilityslot 0
        level 31
        monwithform SPECIES_DARMANITAN, 2 //-Zen
        item ITEM_EXPERT_BELT
        ...
        ball ITEM_REPEAT_BALL
        setivs 25, 25, 25, 25, 31, 25 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_QUIET
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 43, "Chow"
    ...
    party 43
        ...
        ability ABILITY_LEVITATE
        ball ITEM_POKE_BALL
        setivs 10, 11, 11, 11, 11, 11 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_QUIRKY
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 47, "Mikey"
    ...
    party 47
        ...
        abilityslot 0
        level 5
        monwithform SPECIES_WOOPER, 1 //-Paldea
        item ITEM_NONE
...
trainerdata 52, "Edmond"
    ...
    party 52
        ...
        abilityslot 0
        level 12
        monwithform SPECIES_VOLTORB, 1 //-Hisui
        item ITEM_NONE
        move MOVE_ABSORB
        move MOVE_THUNDER_SHOCK
        move MOVE_DOUBLE_TEAM
...
trainerdata 54, "Troy"
    ...
    party 54
        ...
        ability ABILITY_ARENA_TRAP
        ball ITEM_NEST_BALL
        setivs 10, 20, 10, 10, 10, 10 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_BRAVE
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 61, "Anthony"
    ...
    party 61
        ...
        abilityslot 0
        level 18
        monwithform SPECIES_SANDSHREW, 1 //-Alola
        item ITEM_ROCKY_HELMET
        move MOVE_ICE_FANG
        move MOVE_METAL_CLAW
        move MOVE_ICE_SHARD
        ...
        ball ITEM_POKE_BALL
        setivs 20, 20, 20, 19, 19, 20 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_QUIRKY
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 62, "Samuel"
    ...
    party 62
        ...
        ball ITEM_POKE_BALL
        setivs 16, 16, 16, 16, 16, 16 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_ADAMANT
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
        ...
        abilityslot 0
        level 26
        monwithform SPECIES_RATICATE, 1 //-Alola
        item ITEM_NONE
        move MOVE_CRUNCH
        move MOVE_HEADBUTT
        move MOVE_SUPER_FANG
        ...
        ball ITEM_POKE_BALL
        setivs 16, 16, 16, 31, 16, 16 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_QUIRKY
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 65, "Gina"
    ...
    party 65
        ...
        ball ITEM_POKE_BALL
        setivs 31, 16, 16, 16, 16, 16 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_QUIRKY
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 69, "Josh"
    ...
    party 69
        ...
        ability ABILITY_SWARM
        ball ITEM_POKE_BALL
        setivs 18, 18, 18, 18, 18, 18 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_HASTY
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 101, "Grunt"
    ...
    party 101
        ...
        abilityslot 0
        level 20
        monwithform SPECIES_GRIMER, 1 //-Alola
        item ITEM_SITRUS_BERRY
        move MOVE_POISON_TAIL
        move MOVE_FEINT_ATTACK
        move MOVE_PURSUIT
        ...
        ball ITEM_POKE_BALL
        setivs 15, 15, 15, 15, 16, 16 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_MODEST
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 233, "Eric"
    ...
    party 233
        ...
        ability ABILITY_THICK_FAT
        ball ITEM_POKE_BALL
        setivs 16, 15, 16, 15, 16, 16 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_SASSY
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 290, "Li"
    ...
    party 290
        ...
        ability ABILITY_CHLOROPHYLL
        ball ITEM_NEST_BALL
        setivs 19, 19, 20, 20, 19, 20 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_QUIRKY
        shinylock 1 //pokemon is shiny
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
        ballseal 0
        ...
        ability ABILITY_HARVEST
        ball ITEM_NEST_BALL
        setivs 20, 20, 20, 19, 19, 19 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_TIMID
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 327, "Boruto"
    trainermontype TRAINER_DATA_TYPE_ITEMS | TRAINER_DATA_TYPE_MOVES | TRAINER_DATA_TYPE_ITEMS | TRAINER_DATA_TYPE_ABILITY | TRAINER_DATA_TYPE_BALL | TRAINER_DATA_TYPE_IV_EV_SET | TRAINER_DATA_TYPE_NATURE_SET | TRAINER_DATA_TYPE_SHINY_LOCK | TRAINER_DATA_TYPE_ADDITIONAL_FLAGS
    trainerclass TRAINERCLASS_NINJA_BOY
    nummons 3
    item ITEM_NONE
    item ITEM_NONE
    item ITEM_NONE
...
trainerdata 392, "Maurice"
    ...
    party 392
        ...
        abilityslot 0
        level 30
        monwithform SPECIES_QWILFISH, 1 //-Hisui
        item ITEM_NONE
        move MOVE_POISON_TAIL
        move MOVE_AQUA_TAIL
        move MOVE_DRILL_RUN
        ...
        abilityslot 0
        level 30
        monwithform SPECIES_MUK, 1 //-Alola
        item ITEM_NONE
        move MOVE_POISON_JAB
        move MOVE_ASSURANCE
        move MOVE_POWER_UP_PUNCH
	    ...
	    //mon 3
            ...
            abilityslot 0
            level 31
            monwithform SPECIES_WEEZING, 1 //-Galar
            item ITEM_SITRUS_BERRY
            move MOVE_DRAINING_KISS
            move MOVE_FLAMETHROWER
            move MOVE_THUNDERBOLT
...
trainerdata 486, "Proton"
    ...
    party 486
        ...
        ability ABILITY_LEVITATE
        ball ITEM_ULTRA_BALL
        setivs 14, 15, 15, 15, 14, 15 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_BOLD
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 545, "Zetsu"
    ...
    party 545
        ...
        abilityslot 0
        level 26
        monwithform SPECIES_ZORUA, 1 //-Hisui
        item ITEM_NONE
        move MOVE_SLASH
        move MOVE_SHADOW_CLAW
        move MOVE_SHADOW_SNEAK
